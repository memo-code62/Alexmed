    ...
    # استيرادات Gemini
    from llama_index.llms.gemini import Gemini # تم استبدال GeminiMultiModal بـ Gemini
    ...
    # استيراد مكتبات التنزيل (تم حذفها لأنها لم تُستخدم في الدوال أدناه، لكن أبقيتها للاستفادة منها)
    ...
    def setup_rag_engine():
        ...
        try:
            ...
            llm_multi = Gemini(model="gemini-2.5-flash") # Gemini
            # LLM النصي لمحرك الاستعلام النهائي
            llm_text = Gemini(model="gemini-2.5-flash") # Gemini
    ...
    query_engine = setup_rag_engine() # استدعاء setup_rag_engine هنا
